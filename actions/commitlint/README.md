...
Composite GitHub Action that validates Conventional Commits in a git range using
...
- Requires `fetch-depth: 0` on the checkout step so the full commit history is
  available.
